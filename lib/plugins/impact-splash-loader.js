...
ig.ImpactSplashLoader = ig.Loader.extend({
	...
	title: new ig.Image( 'media/loading.png' ),
	...
	draw: function() {
		...
		ctx.save();
			...
			// compute width of the logo
			// logoWidth = ig.system.realWidth * 0.95;
			// var scale = logoWidth / this.logoWidth;
			// console.log(this.title.width + " : " + logoWidth);
			// this.title.width = logoWidth;
			// this.title.height = Math.round(this.logoHeight * scale);
			// // console.log(ig.system.width);
			// var cx = ig.system.realWidth/2;
			// // console.log((ig.system.realWidth) + " : " + (this.title.width) + " : "  + (cx - (this.title.width/2)));
			// this.title.draw( cx - logoWidth/2, 50 );
			...
			ctx.strokeRect( 25, this.logoHeight, 500, 20 );
			
			ctx.fillStyle = 'rgb(255,255,255)';
			ctx.fillRect( 30, this.logoHeight + 5, 290 * this._drawStatus, 10 );		
