...
EntityLevelmessage = ig.Entity.extend({
	_wmDrawBox: true,
	...
	triggeredBy: function( entity, trigger ) {
		if( this.level ) {
			...
			ig.system.currentScore = ig.game.player.coins;
			ig.system.nextLevel = 'Level' + levelName;
			ig.system.setGameNow( ig.global['MyGame'] );
			return false;
		}
	},
